...
Neste guia você vai criar seu primeiro bot funcional com Nexo.js.
...
```ts
import { Bootstrap } from '@mitsuk/nexo.js';
...
```ts
import { createCommand, CommandType } from '@mitsuk/nexo.js';
