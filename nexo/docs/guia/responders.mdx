...
```js
const { createCommand, createResponder, CommandType, ResponderType } = require('nexo.js');
...
```ts
import { createCommand, createResponder, CommandType, ResponderType } from 'nexo.js';
